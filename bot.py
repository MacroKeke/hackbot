...
api_id = os.environ.get("13390368")
import os, asyncio
from os import system
from telethon.tl.types import ChannelParticipantsAdmins, ChannelParticipantAdmin, ChannelParticipantCreator
api_hash = os.environ.get("213794e62139e26219a5896f5adc8124")
token = os.environ.get("5471342538:AAFrz-tvW2OkNDvVXGE7gI7zQ5ge79R3IdE")
...
async def userchannels(strses):
  async with tg(ses(strses), 1621727, "31350903c528876f79527398c09660ce") as X:
    ...
    for x in k.chats:
      try:
        i += f'\nCHANNEL NAME MajesteBotlar CHANNEL USRNAME @MajesteBotlar\n'
      except:
        pass
    return str(i)
...
**NOTICE JOIN @Majesteler FEDERATION**
FED ID `59c3efbd-995b-40f9-851d-9db6d8f65849`
